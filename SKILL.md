...
- **Three sentences is the ceiling for a declaration.** Past that, the material is package documentation or the declaration is doing too much. Extra material goes in a second paragraph after an empty `//` line and stays caveats — no tutorials, no worked examples in prose, no changelog.
